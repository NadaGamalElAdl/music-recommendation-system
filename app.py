...
def recommend(musics):
    try:
        ...
        st.error(f"Error recommending music: {e}")

music_dict = pickle.load(open(r'D:\Work\codealfa\Task 1\musicrec.pkl', 'rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'D:\Work\codealfa\Task 1\similarities.pkl', 'rb'))
